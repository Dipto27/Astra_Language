...
int disassembleInstruction(Chunk* chunk, int offset) {
    ...
    switch (instruction) {
        ...
        case OP_NONE:          return simpleInstruction("OP_NONE", offset);
        ...
        case OP_GET_SLICE:     return simpleInstruction("OP_GET_SLICE", offset);

        case OP_STRUCT:        return constantInstruction("OP_STRUCT", chunk, offset);
        ...
        case OP_ITERATOR:      return simpleInstruction("OP_ITERATOR", offset);
        case OP_ITERATOR_NEXT: return jumpInstruction("OP_ITERATOR_NEXT", 1, chunk, offset);

        case OP_PIPE:          return simpleInstruction("OP_PIPE", offset);
